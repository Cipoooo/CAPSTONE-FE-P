        ...
        <>
         <Container sm className="MainContainerXbox">
            <div className="XboxImageContainer">
               <img src="../src/assets/xbox-logo-light.webp" className="XboxImg"alt="Xbox logo"/>
            </div>
            <div className="d-flex justify-content-center mt-3">
                <Link to={"/XboxOne"}><button className="buttonXbox rounded-pill p-2 px-3 me-3">XBOX One</button></Link>
