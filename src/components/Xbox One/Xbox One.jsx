...
const XboxOne = () =>{
    ...
    return(
        ...
        {/*<Container sm className="ContainerGiocoSingoloX" >
                  <div className="GiocoSingoloImageX"></div>
                  <div className="ContainerGiocoSingoloInfo">
                    <p className="GiocoTitolo text-white">Migliore su XBox : <br className="ln-0"/> Halo Infinite</p>
         ...
         <Container className="MainContainerXbox">
            <div className="d-flex justify-content-center mt-3">
              ...
              <Row className="gx-4 gy-2">
                ...
                {videogiochi.filter(videogioco => !videogioco.piattaforma.includes("Xbox Series X/S, PS4,PS5,Nintendo Switch,PC")).slice(-50).map((videogioco,i)=>(
